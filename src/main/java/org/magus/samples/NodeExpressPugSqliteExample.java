 ...
 *
 */
public class NodeExpressPugSqliteExample {
	...
	private void generateApp(String archetype, App app) throws Exception {
		...
		// processAppTemplate(app, root, archetype + "config/database.config.js.ftlh",
		// "/config/database.config.js");
		// processAppTemplate(app, root, archetype + "app.js.ftlh", "/app.js");
		// processAppTemplate(app, root, archetype + "package.json.ftlh",
		// "/package.json");
		// processAppTemplate(app, root, archetype + "README.md.ftlh", "/README.md");
		// processAppTemplate(app, root, archetype + "app/models/schema.model.js.ftlh",
		// "/app/models/schema.model.js");
		// processAppTemplate(app, root, archetype +
		// "app/controllers/app.controller.js.ftlh",
		...
		// processAppTemplate(app, root, archetype + "app/views/content.ejs.ftlh",
		// "/app/views/content.ejs");
		// processAppTemplate(app, root, archetype + "app/views/controlbar.ejs.ftlh",
		// "/app/views/controlbar.ejs");
		// processAppTemplate(app, root, archetype + "app/views/footer.ejs.ftlh",
		// "/app/views/footer.ejs");
		// processAppTemplate(app, root, archetype + "app/views/index.ejs.ftlh",
		// "/app/views/index.ejs");
		// processAppTemplate(app, root, archetype + "app/views/leftbar.ejs.ftlh",
		// "/app/views/leftbar.ejs");
		// processAppTemplate(app, root, archetype + "app/views/topbar.ejs.ftlh",
		// "/app/views/topbar.ejs");

		for (Model m : app.getModels()) {
			root.put("model", m);
			processAppTemplate(app, root, archetype + "database.ftlh", "/database.sql");
	...
	public static void main(String[] args) throws Exception {
		...
		InputStream in = NodeExpressPugSqliteExample.class.getResourceAsStream("node-express-pug-sqlite-app.json");
		...
		NodeExpressPugSqliteExample t = new NodeExpressPugSqliteExample();
		t.setupTemplate();
		// t.createApp();
		t.generateApp("/archetypes/node-express-pug-sqlite/templates/", app);
